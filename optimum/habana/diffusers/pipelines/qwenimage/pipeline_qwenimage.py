...
class GaudiQwenImagePipeline(GaudiDiffusionPipeline, QwenImagePipeline, QwenImageLoraLoaderMixin):
    r"""
    ...
    def _split_inputs_into_batches(
        ...
        return (
            ...
            None, #prompt_embeds_mask_batches,
            guidance_batches,
            num_dummy_samples,
        )
            ...
            for i in self.progress_bar(range(len(timesteps))):
                ...
                if quant_mode == "quantize-mixed" and i >= quant_mixed_step:
                    ...
                    noise_pred = transformer_bf16(
                        ...
                        encoder_hidden_states_mask=None, #text_embeddings_mask_batch, #prompt_embeds_mask,
                        encoder_hidden_states=text_embeddings_batch,           #prompt_embeds,
